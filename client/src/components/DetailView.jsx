...
export default function DetailView() {
  ...
  //has own property implementation for differentiation between player detail and bet placing
  ...
  return (
    <div className="detail--view--container">
      ...
      <div className='video--embed'>
        <iframe src="https://www.youtube.com/watch?v=BEENL2t1Qzs&ab_channel=Criseditz" frameborder="60" width="600px" height="500px"></iframe>
      </div>
    </div>
  )
}
